...
function listar() {
    ...
    var instrucao = `
        SELECT u.id,u.email,u.senha,u.fkTipoUsuario,u.fkFuncionario, t.tipoUsuario, f.nome FROM usuario u join tipoUsuario t on u.fkTipoUsuario = t.id join funcionario f on u.fkFuncionario = f.id;
    `;
